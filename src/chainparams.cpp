...
public:
    CMainParams() {
        ...
        const char *pszTimestamp = "reaally cool";
...
//         printf("genesis.GetHash = %s\n", genesis.GetHash().ToString().c_str());
  //       printf("merkle = %s\n", genesis.hashMerkleRoot.ToString().c_str());
        ...
        assert(hashGenesisBlock == uint256("0xb516025d94122983cefd1e2f6fd9bad39f194df4eee2353406676d6b8e8903d7"));
        assert(genesis.hashMerkleRoot == uint256("0x6f611af8c567a68bf4a8d35921fb97fad1655568d2c9cb406801089f7aaa8ab3"));

        vSeeds.push_back(CDNSSeedData("n0", "45.77.78.72"));
        vSeeds.push_back(CDNSSeedData("n1", "104.207.129.122"));
